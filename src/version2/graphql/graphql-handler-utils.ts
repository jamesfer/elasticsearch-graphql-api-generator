import { QueryContainer, SortCombinations } from '@elastic/elasticsearch/api/types';
import { schema } from 'avsc';
import { compact } from 'fp-ts/Array';
import { compact as recordCompact, map as recordMap, mapWithIndex } from 'fp-ts/Record';
